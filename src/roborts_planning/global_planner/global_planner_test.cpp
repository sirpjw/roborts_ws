...
class GlobalPlannerTest{
 public:
  GlobalPlannerTest(): global_planner_actionlib_client_("global_planner_node_action", true){
    ros::NodeHandle rviz_nh("move_base_simple");
    goal_sub_ = rviz_nh.subscribe<geometry_msgs::PoseStamped>("goal", 1, &GlobalPlannerTest::GoalCallback,this);
    path_pub_ = rviz_nh.advertise<nav_msgs::Path>("global_planner_path", 1);
